...
| Requirement | Status | Implementation File(s) | Test File(s) | Notes |
| :--- | :---: | :--- | :--- | :--- |
| **Multilingual NLP Assistant** | **Done** | [`backend/src/services/openRouterAdvisorService.js`](backend/src/services/openRouterAdvisorService.js)<br>[`frontend/src/components/chat/SidePanelChatbot.tsx`](frontend/src/components/chat/SidePanelChatbot.tsx)<br>[`frontend/src/engine/aiAdvisorEngine.ts`](frontend/src/engine/aiAdvisorEngine.ts) | [`backend/src/services/advisorService.test.js`](backend/src/services/advisorService.test.js) | Powered by OpenRouter with strict prompt grounding; falls back to deterministic local NLP if offline or unconfigured. Supports English, Hindi, and Telugu. |
| **Inputs: Village, Block, District, Margin Capital, Business Category** | **Done** | [`frontend/src/components/modules/NewBusinessFlow.tsx`](frontend/src/components/modules/NewBusinessFlow.tsx)<br>[`frontend/src/engine/locationParser.ts`](frontend/src/engine/locationParser.ts)<br>[`backend/src/services/geocodeService.js`](backend/src/services/geocodeService.js) | [`frontend/src/components/modules/NewBusinessFlow.test.tsx`](frontend/src/components/modules/NewBusinessFlow.test.tsx)<br>[`frontend/src/engine/locationParser.test.ts`](frontend/src/engine/locationParser.test.ts) | Nominatim geocoding extracts administrative hierarchy (village, block/tehsil/mandal, district, state); Capital step collects promoter margin money with live scheme preview. |
| **Project Cost = Margin / 10%** | **Done** | [`frontend/src/engine/psCalculator.ts`](frontend/src/engine/psCalculator.ts)<br>[`frontend/src/engine/schemeReconciliation.ts`](frontend/src/engine/schemeReconciliation.ts) | [`frontend/src/engine/psCalculator.test.ts`](frontend/src/engine/psCalculator.test.ts)<br>[`frontend/src/engine/schemeReconciliation.test.ts`](frontend/src/engine/schemeReconciliation.test.ts) | Evaluated strictly as `projectCost = availableMargin / 0.10` in `psCalculator.ts`. When estimated capex differs, `schemeReconciliation.ts` computes exact margin adequacy and shortfall. |
| **Loan = 90% with Scheme Caps** | **Done** | [`frontend/src/engine/psCalculator.ts`](frontend/src/engine/psCalculator.ts)<br>[`frontend/src/components/common/SchemeLoanBreakdown.tsx`](frontend/src/components/common/SchemeLoanBreakdown.tsx) | [`frontend/src/engine/psCalculator.test.ts`](frontend/src/engine/psCalculator.test.ts)<br>[`frontend/src/components/common/SchemeLoanBreakdown.test.tsx`](frontend/src/components/common/SchemeLoanBreakdown.test.tsx) | Calculates `loan = min(0.90 * projectCost, schemeMaxLoan)`. Caps at ₹1,25,000 for Micro Finance and ₹45,00,000 for Term Loan, identifying any remaining contribution gap. |
| **Micro Finance & Term Loan Routing (Rates, Tenures, Moratoria)** | **Done** | [`frontend/src/engine/psCalculator.ts`](frontend/src/engine/psCalculator.ts) | [`frontend/src/engine/psCalculator.test.ts`](frontend/src/engine/psCalculator.test.ts) | Micro Finance (cost $\le$ ₹1.40L): 6.5% p.a., 3 years (12 quarters), 3-month moratorium. Term Loan (₹1.40L < cost $\le$ ₹50L): 8.0% p.a., 7 years (28 quarters), 6-month moratorium. |
| **Quarterly Repayment Schedule** | **Done** | [`frontend/src/engine/psCalculator.ts`](frontend/src/engine/psCalculator.ts)<br>[`frontend/src/components/common/SchemeLoanBreakdown.tsx`](frontend/src/components/common/SchemeLoanBreakdown.tsx) | [`frontend/src/engine/psCalculator.test.ts`](frontend/src/engine/psCalculator.test.ts)<br>[`frontend/src/components/common/SchemeLoanBreakdown.test.tsx`](frontend/src/components/common/SchemeLoanBreakdown.test.tsx) | Generates full quarterly amortization table with serviced or capitalised interest during moratorium, post-moratorium principal amortization, and exact ₹0 terminal balance. |
| **Market Reach (5 km & 10 km)** | **Done** | [`frontend/src/components/modules/MarketMap.tsx`](frontend/src/components/modules/MarketMap.tsx)<br>[`backend/src/services/localFeasibilityService.js`](backend/src/services/localFeasibilityService.js)<br>[`frontend/src/engine/decisionEngine.ts`](frontend/src/engine/decisionEngine.ts) | [`backend/src/services/localFeasibilityService.test.js`](backend/src/services/localFeasibilityService.test.js)<br>[`frontend/src/engine/localFeasibilityEngine.test.ts`](frontend/src/engine/localFeasibilityEngine.test.ts) | Evaluates and maps both 5 km Micro-Catchment and 10 km Macro-Catchment radial perimeters with Leaflet concentric circles and logistics distribution channels. |
| **Opportunity Analysis** | **Done** | [`backend/src/services/localFeasibilityService.js`](backend/src/services/localFeasibilityService.js)<br>[`frontend/src/components/modules/LocalFeasibilityReportView.tsx`](frontend/src/components/modules/LocalFeasibilityReportView.tsx) | [`backend/src/services/localFeasibilityService.test.js`](backend/src/services/localFeasibilityService.test.js)<br>[`frontend/src/components/modules/LocalFeasibilityReportView.test.tsx`](frontend/src/components/modules/LocalFeasibilityReportView.test.tsx) | Discovers underserved product niches and demand gaps based on local footfall and competitor deficits, validated with a strict Zod schema. |
| **SWOT Analysis** | **Done** | [`backend/src/services/localFeasibilityService.js`](backend/src/services/localFeasibilityService.js)<br>[`frontend/src/components/modules/DecisionDashboard.tsx`](frontend/src/components/modules/DecisionDashboard.tsx) | [`backend/src/services/localFeasibilityService.test.js`](backend/src/services/localFeasibilityService.test.js)<br>[`frontend/src/components/modules/LocalFeasibilityReportView.test.tsx`](frontend/src/components/modules/LocalFeasibilityReportView.test.tsx) | Full 4-quadrant Strengths, Weaknesses, Opportunities, and Threats mapped for rural enterprises, with unabbreviated titles and deterministic fallback templates. |
| **Threats & Mitigations** | **Done** | [`backend/src/services/localFeasibilityService.js`](backend/src/services/localFeasibilityService.js)<br>[`frontend/src/components/modules/DecisionDashboard.tsx`](frontend/src/components/modules/DecisionDashboard.tsx) | [`backend/src/services/localFeasibilityService.test.js`](backend/src/services/localFeasibilityService.test.js)<br>[`frontend/src/components/modules/Deduplication.test.tsx`](frontend/src/components/modules/Deduplication.test.tsx) | Identifies operational threat types (`supply_chain`, `seasonal`, `single_buyer`, `other`) paired with actionable mitigations (e.g. working capital buffer reserves). |
| **Competitor Mapping** | **Done** | [`backend/src/services/placesService.js`](backend/src/services/placesService.js)<br>[`frontend/src/services/placesService.ts`](frontend/src/services/placesService.ts)<br>[`frontend/src/components/modules/MarketMap.tsx`](frontend/src/components/modules/MarketMap.tsx) | [`backend/src/services/placesService.test.js`](backend/src/services/placesService.test.js) | Server-side Overpass API proxy queries real OpenStreetMap POIs within 5-10 km, plotting competitor locations, distance, and density per 10,000 population. |
| **Pricing Guidance** | **Done** | [`backend/src/services/localFeasibilityService.js`](backend/src/services/localFeasibilityService.js)<br>[`frontend/src/components/modules/LocalFeasibilityReportView.tsx`](frontend/src/components/modules/LocalFeasibilityReportView.tsx) | [`backend/src/services/localFeasibilityService.test.js`](backend/src/services/localFeasibilityService.test.js) | Provides sector-specific cost-plus pricing strategies and price band verification guidance aligned with local mandi/market benchmarks. |
