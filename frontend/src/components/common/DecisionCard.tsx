          ...
          <div className="bg-white dark:bg-[#0E0E0E] rounded-xl p-4 sm:p-5 border border-indigo-200 dark:border-neutral-800 shadow-sm mt-3 animate-in fade-in">
            ...
            <div className="bg-amber-50/80 dark:bg-[#1A1202] p-3 rounded-xl border border-amber-200 dark:border-amber-900 flex items-start gap-2.5 text-xs text-amber-950 dark:text-amber-200 font-medium leading-relaxed">
              ...
              <span>
                ...
                {language === 'te'
                  ? 'ప్రవీరక్ ఎప్పుడూ కల్పిత డేటాను చూపించదు. ఆధారాల ట్యాగ్‌లు ఈ అంశాలు మునిసిపల్ రికార్డుల నుండి సేకరించబడ్డాయా, ప్రభుత్వ ప్రమాణాల ద్వారా అంచనా వేయబడ్డాయా లేదా AI ద్వారా విశ్లేషించబడ్డాయా అని స్పష్టంగా సూచిస్తాయి.'
                  : language === 'hi'
                  ? 'प्रवीरक कभी भी काल्पनिक डेटा नहीं दिखाता। प्रमाण टैग स्पष्ट रूप से दर्शाते हैं कि कारक नगरपालिका रिकॉर्ड से लिए गए हैं, सरकारी मानकों द्वारा अनुमानित हैं या AI द्वारा विश्लेषित हैं।'
                  : 'Never present simulated or estimated market data as live real-world evidence. Provenance tags explicitly show whether factors are Sourced from public municipal records, Estimated via priority sector benchmarks, or generated by AI Interpretation.'}
              </span>
            </div>
          </div>
        )}
